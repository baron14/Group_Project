...
<!DOCTYPE html>
	...
	<div id="Header">	
		...
		<div id="InfoBlock">
			<br>
			<form>
				<p>Input your current password: <input type="text" id="OldChangePassword" name="OldChangePassword" size="16"/></p>
				<p>Input a new password: <input type="text" id="NewChangePassword" name="NewChangePassword" size="16"/></p>
				<br>
				<input id="ChangePasswordButton" type="submit" value="Change Password" onclick=""/>
			</form>
			<br><br>
		</div>
