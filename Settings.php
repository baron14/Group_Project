...
<!DOCTYPE html>
	...
	<div id="Header">	
		...
		<div id="InfoBlock">
			<br>
			<form>
				<select id="ColourBlind" name="ColourBlind">
					<option value ="NotColourBlind" selected="selected">Not Colour Blind</option>
					<option value ="ColourBlind1">Colour Blind 1</option>
					<option value ="ColourBlind2">Colour Blind 2</option>
				</select>
				<p>Large Font</p><input id="FontSize" name="FontSize" type="checkbox">
				<input id="SaveSettings" type="submit" value="Save Settings"/>
			</form>
		</div>
