<!DOCTYPE html>
	...
	<div id="Header">	
		<div id="Banner">
			<img src="Banner.png" alt="Logo and Banner" width="1100">
			<h2><input id="SaveButton" type="button" value="Save"/>
			<form id="helpButton" method="POST" action="Help.html">
				<input id="HelpButton" type="submit" value="Help"/>
			</form>
			<input id="LogoutButton" type="button" value="Log Out"/>
			You are logged in as <a href="Account.php">*name*</a></h2>
		</div> <!--Banner-->
	</div><!--Header-->	
	...
	<div class='content'>	
		<div id="SideBar">
			...
			<script type="text/javascript">getJobs('<?php echo $_POST["Username"];?>');</script>
